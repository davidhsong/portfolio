      ...
      <div className="navbar-container">
        ...
        <nav className={`navbar-links ${menuOpen ? 'active' : ''}`}>
          <ul>
            ...
            <li><Link to="/about" className={location.pathname === '/about' ? 'active' : ''}>{t('navbar.about')}</Link></li>
            <li><Link to="/projects" className={location.pathname.startsWith('/projects') ? 'active' : ''}>{t('navbar.projects')}</Link></li>
            <li><Link to="/resume" className={location.pathname === '/resume' ? 'active' : ''}>{t('navbar.resume')}</Link></li>
